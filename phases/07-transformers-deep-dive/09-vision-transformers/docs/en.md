...
- [NielsRogge, Transformers-Tutorials — `VisionTransformer/Quick_demo_of_HuggingFace_version_of_Vision_Transformer_inference.ipynb`](https://github.com/NielsRogge/Transformers-Tutorials/blob/master/VisionTransformer/Quick_demo_of_HuggingFace_version_of_Vision_Transformer_inference.ipynb) — minimal end-to-end ViT inference; pairs with Step 5 (head) above.
- [NielsRogge, Transformers-Tutorials — `VisionTransformer/Fine_tuning_the_Vision_Transformer_on_CIFAR_10_with_PyTorch_Lightning.ipynb`](https://github.com/NielsRogge/Transformers-Tutorials/blob/master/VisionTransformer/Fine_tuning_the_Vision_Transformer_on_CIFAR_10_with_PyTorch_Lightning.ipynb) — the Exercise 3 template (train ViT on CIFAR-sized data) done properly.
- [NielsRogge, Transformers-Tutorials — `DINOv2/Fine_tune_DINOv2_for_image_classification_[minimal].ipynb`](https://github.com/NielsRogge/Transformers-Tutorials/blob/master/DINOv2/Fine_tune_DINOv2_for_image_classification_%5Bminimal%5D.ipynb) — the "freeze backbone, train a head" pattern this lesson's Use It recommends.
- [NielsRogge, Transformers-Tutorials — `ViTMAE/ViT_MAE_visualization_demo.ipynb`](https://github.com/NielsRogge/Transformers-Tutorials/blob/master/ViTMAE/ViT_MAE_visualization_demo.ipynb) — masked autoencoder pretraining (the self-supervised predecessor to DINOv2) with patch-level visualizations.
- [NielsRogge, Transformers-Tutorials — `Swin2SR/`](https://github.com/NielsRogge/Transformers-Tutorials/tree/master/Swin2SR) — Swin applied to image super-resolution; concrete use of shifted-window attention.
